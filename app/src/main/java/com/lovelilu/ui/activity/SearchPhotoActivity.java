 ...
 */
public class SearchPhotoActivity extends SwipeBackActivity implements BGARefreshLayout.BGARefreshLayoutDelegate {
    ...
    private void init() {
        ...
        String json = getIntent().getStringExtra(Constants.KEY.JSON_LIST_PHOTO);
        mList = JSONUtil.fromJson(json, new TypeToken<List<Photo>>() {
        }.getType());
    }
...
//        rl_refresh.setBackgroundColor(getResources().getColor(R.color.bg));
    ...
    private void initAdapter() {
        mAdapter = new PhotoListAdapter(this, R.layout.item_photo, mList);
...
//        mainQuery.or(queries);
    ...
    private void showListData(List<Photo> list) {
